...
class KangarooRewardsPointsResponse {
    ...
    @SerializedName("FullAppliedOnFlight")
    @Expose
    var FullAppliedOnFight: Boolean = false
    @SerializedName("FullAppliedOnHotel")
    @Expose
    var FullAppliedOnHotel: Boolean = false
}